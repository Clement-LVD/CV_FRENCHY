...
- ⏩ **Rôle de 1^er^ méthodologiste, *data-engineer* et *lead-dev'* ** (création, déploiement et maintien d'outils informatiques en R)
  ...
  - 🤵 Assure la dimension législative^[p. ex. interlocuteur de la CNIL [...] mise en place d'une procédure de poursuite en justice de 31 promoteurs ne délivrant pas les données demandées en 2024] et l'évolution méthodologique de l'enquête ECLN^[p. ex. correction d'erreurs ; automatisation de la valorisation des résultats ; modifications de procédures ; intégration d'une catégorie "d'autres ventes" pour capter +33% du marché immobilier non-capté par l'enquête actuelle]
  - 🐙 Et d'autres tâches (gestion des 4 boîtes mails associées à ces activités, animation de séminaires et conférences, veille du marché, etc.)
...
<div class='job'>
**💼 2015** : <b>Chargé de recherches - *Research internship* 8 mois - *Mairie d'Igny*</b>
...
**💼 2014** : <b>Analyste de la base de données de recrutement - CDD 4 mois - *DRH de l'Armée de Terre*</b>

  - ⏩ Analyses de la qualité psychométrique des tests de recrutement et des facteurs conduisant à la démission des soldats
</div>
