...
- Je suis expérimenté :
-   - en conception de recherches psyscho-sociologiques ou d'enquêtes
-   - en analyse d'enquêtes, mais aussi de textes, cartes, réseaux de relations, bases de données...
-   - en restitution des résultats (rapports, articles, conférences, etc.)
...
- ⏩ Analyses d'enquêtes, de littérature et de bases de données
